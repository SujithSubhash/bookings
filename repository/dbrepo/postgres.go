...
// InsertReservation insert reservation in to the database
...
// SearchAvailabilityByDatesByRoomID returns true if availability exists for roomID, and false no availability exists
